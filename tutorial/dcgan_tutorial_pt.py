...
# Number of workers (threads) for dataloader
workers = 64
...
for epoch in range(num_epochs):
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        iters += 1
    for j, img in enumerate(fake): # j = num of fake images
        save_image(img, f'generated_images/xl_image_{epoch}_{i}_{j}.png')
...
PATH_G = './models/dcgan_g.pth'
torch.save(netG.state_dict(), PATH_G)
# Save the discriminator model
PATH_D = './models/dcgan_d.pth'
